...
I have noticed that on Safari and Internet Explorer there was a gap between the Home and About page. To fix this I removed ```padding: 450px``` from Hero Image and replaced it in ```.name-heading```.
...
### Validators 
The site's HTML code has been tested in [W3 Validator](https://validator.w3.org/) , CSS code in [Jigsaw Validator](https://jigsaw.w3.org/css-validator/) and [Responsinator](https://www.responsinator.com/).
